...
// const useController = ({ data, width, height }) => {
//     const xMin = useMemo(
//         () => d3.min(data, ({itmes}) => d3.min(itmes, ({date}) => date)),
//         [data]
//     );
//     const xMax = useMemo(
//         () => d3.max(data, ({itmes}) => d3.max(itmes, ({date}) => date)),
//         [data]
//     );
//     const xScale = useMemo(
//         () => d3.scaleTime().domain([xMin, xMax]).range([0, width]),
...
//     );
//     const yMin = useMemo(
//         () => d3.min(data, ({itmes}) => d3.min(itmes, ({value}) => value)),
//         [data]
//     );
//     const yMax = useMemo(
//         () => d3.max(data, ({itmes}) => d3.max(itmes, ({value}) => value)),
//         [data]
//     );
//     const yScale = useMemo(() => {
//         const indention = (yMax - yMin) * 0.5 
